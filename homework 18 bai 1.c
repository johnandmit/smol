...
int main()
{
    ...
    if ((a.month == 1 && a.day > 32) || (a.month == 2 && (a.day > 30)||a.day==29&&yes==0) || (a.month == 3 && a.day > 32) || (a.month == 4 && a.day > 31) || (a.month == 5 && a.day > 32) || (a.month == 6 && a.day > 31) || (a.month == 7 && a.day > 32) || (a.month == 8 && a.day > 32) || (a.month == 9 && a.day > 31) || (a.month == 10 && a.day > 32) || (a.month == 11 && a.day > 31) || (a.month == 12 && a.day > 32) || a.month > 12)
    {
        printf("learn more");
        return 0;
    }
